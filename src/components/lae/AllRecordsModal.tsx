...
export function AllRecordsModal({
  open,
  onOpenChange,
  assignmentId,
  assignmentName,
  ...
  const handleExport = () => {
    ...
    try {
      ...
      const safeName = assignmentName?.replace(/[^a-zA-Z0-9]/g, "_") || "data";
      const filename = `${safeName}_all_records_${today}.xlsx`;
      ...
      <DialogContent className="max-w-[90vw] h-[85vh] flex flex-col p-0 gap-0">
        <DialogHeader className="px-6 py-4 border-b shrink-0">
          <DialogTitle className="flex items-center gap-2 text-lg">
            ...
            {assignmentName} - All Applications Generated
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-auto px-6 py-4">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="text-muted-foreground">Loading all records...</p>
            </div>
          ) : error ? (
            <div className="flex flex-col items-center justify-center h-full">
            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="text-sm text-muted-foreground">
                There are no records in this assignment.
              </p>
            </div>
          )}
        </div>
